...
# DeepSeek R1 as primary, followed by Claude 3.5 Haiku and Claude 3 Haiku
AI_MODELS = [
    {
        'id': 'deepseek-r1',
        'name': 'DeepSeek R1',
        ...
        def call_bedrock_with_fallback(prompt):
            ...
            for i, model in enumerate(AI_MODELS):
                try:
                    ...
                    # Handle external API (DeepSeek) vs AWS Bedrock
                    if model.get('is_external'):
                        # Call external DeepSeek API
                        import requests
                        import os
                        ...
                        request_body = {
                            ...
                            "messages": [
                                {
                                    "role": "system",
                                    "content": "You are an expert ATS resume optimizer that preserves document formatting."
                                },
                                {
                                    "role": "user", 
                                    "content": prompt
                        ...
                        optimized_resume = response_data['choices'][0]['message']['content']
