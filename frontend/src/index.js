...
const userPoolId = process.env.REACT_APP_USER_POOL_ID || 'us-east-1_RFsEVrGxp';
const userPoolWebClientId = process.env.REACT_APP_USER_POOL_WEB_CLIENT_ID || '4gpgj1rubf5v84kptlfhi8j6c6';
